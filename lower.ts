...
function flattenExprToExpr(e : AST.Expr<Type>, blocks: Array<IR.BasicBlock<Type>>, env : GlobalEnv) : [Array<IR.VarInit<Type>>, Array<IR.Stmt<Type>>, IR.Expr<Type>] {
  switch(e.tag) {
    case "uniop":
    ...
    case "if-expr":
      ...
      var elseLbl = generateName("$ifExperElse");
      var endLbl = generateName("$ifExperEnd");
      var ifExprTmpVal = generateName("$ifExprTmp");

      var endjmp : IR.Stmt<Type> = { tag: "jmp", lbl: endLbl };
      var [cinits, cstmts, cexpr] = flattenExprToVal(e.cond, blocks, env);
      var condjmp : IR.Stmt<Type> = { tag: "ifjmp", cond: cexpr, thn: thenLbl, els: elseLbl };
    ...
    default:
      console.log(e)
      throw new Error("Error in lower flattenExprToExpr. Unkown tag")
  }
}

function flattenExprToVal(e : AST.Expr<Type>,blocks: Array<IR.BasicBlock<Type>>, env : GlobalEnv) : [Array<IR.VarInit<Type>>, Array<IR.Stmt<Type>>, IR.Value<Type>] {
